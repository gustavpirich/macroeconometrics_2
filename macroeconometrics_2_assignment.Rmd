...
x <- seq(2, 2.4, by = 0.0001)

plot(x, dnorm(x, mu_50, sqrt(sigma_50)), type="l", col="red", lwd=2, xlab="x", ylim = c(0,20), ylab="Density", main = "Posterior Distributions for Prior N(4, 1)")
lines(x, dnorm(x, mu_100, sqrt(sigma_100)), type="l", col="blue", lwd=2)
lines(x, dnorm(x, mu_200, sqrt(sigma_200)), type="l", col="green", lwd=2)
...
# Plot two histograms on the same chart with transparency
hist(data1, col=rgb(1,0,0,0.5), ylim = c(0,400), main="Histograms of Two Normally Distributed Priors N(12,1) and N(11,1)")
hist(data2, col=rgb(0,0,1,0.5), add=TRUE)
```
